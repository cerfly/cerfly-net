---
layout: post.njk
title: How I Built This Site — No Frameworks, No Excuses
ogTitle: How I built this site
date: 2026-09-05
category: Web Development
tags:
  - post
description: Every line of cerfly.net is vanilla HTML, CSS and JS, written by opencode with cerfly directing and reviewing.
excerpt: The whole site is vanilla HTML, CSS, and JS. opencode writes the code — I do the suggesting, the reviewing, and the deciding.
zhTitle: How I Built This Site — No Frameworks, No Excuses
zhCategory: 网页开发
zhExcerpt: 整个网站都是原生 HTML、CSS 和 JS。代码由 opencode 写，我负责提建议、做审查、最后拍板。
permalink: /posts/how-i-built-this-site.html
---
